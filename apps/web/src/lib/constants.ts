...
export const CAMERA_PRESETS: Record<string, { target: [number, number, number]; position: [number, number, number]; description: string }> = {
  ...
  cam_valve_station_601:   { target: [-52.2, -47.9, 39.8],  position: [27.8, 12.1, 119.8],     description: '밸브 스테이션 #1 ISO 뷰' },
  cam_valve_station_602:   { target: [-2.5, 177.4, 39.8],   position: [77.5, 237.4, 119.8],    description: '밸브 스테이션 #2 ISO 뷰' },
